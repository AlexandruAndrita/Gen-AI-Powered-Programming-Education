...
if __name__ == "__main__":
    ...
    data_file = "/content/project_part2_dataset_training_combined_I15_I16.jsonl"  # Change this to the path of the training dataset (i.e. the jsonl file you assembled)
    output_dir = f"project_part2_models/Phi-3-SFT-Repair_Hints_r{lora_r}_alpha{lora_alpha}_I15_I16" # Change this to the desired output directory
