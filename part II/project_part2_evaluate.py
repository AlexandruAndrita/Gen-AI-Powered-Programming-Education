...
if __name__ == "__main__":        
    ...
    # model_selected = "project_part2_models/Phi-3-SFT-Repair_r16_alpha32" # Change this to point to the path of the model you want to evaluate
    model_selected = "project_part2_models/Phi-3-SFT-Repair_Hints_r16_alpha32_I15_I16"
