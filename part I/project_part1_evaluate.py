...
class ProgramEvaluation:
    ...
    def get_hint(self, problem_data, buggy_program, testcases):
        extracted_hint, extracted_explanation = self.hint_agent.generate_hint(problem_data, buggy_program, testcases)
        return extracted_hint, extracted_explanation
            ...
            if "prog_" in program_folder:
                ...
                with open(buggy_code_path, "r") as file:
                    ...
                    if self.mode == "repair":
                        ...
                        hint, explanation = self.programEvaluator.get_hint(problem_data, buggy_code, testcases)
                        program_results["hint"] = hint
                        program_results["explanation"] = explanation
